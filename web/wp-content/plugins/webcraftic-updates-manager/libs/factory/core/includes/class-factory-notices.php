...
class Notices {
	...
	public function currentScreenAction() {
		 ...
		 */
		$this->notices = wbcr_factory_420_apply_filters_deprecated( 'wbcr_factory_notices_407_list', [
			$this->notices,
			$this->plugin->getPluginName(),
		], '2.1.2', 'wbcr/factory/admin_notices' );

		/**
		 * @since 2.1.2 - Добавлен, модуль factory_notices_407 был удален. Поэтому в этому хуке мы заменили префикс на factory_420
		 */
