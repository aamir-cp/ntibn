...
<div class="wpem-event-box-col wpem-col wpem-col-12 wpem-col-md-6 wpem-col-lg-4 "><!----- wpem-col-lg-4 value can be change by admin settings ------->
  ...
  <div <?php event_listing_class('wpem-event-layout-wrapper'); ?>>
    <!--<a href="#" class="wpem-event-action-url event-style-color <?php echo $event_type;?>">-->
...
<!--          <div class="wpem-event-date">
      ...
      <div class="wpem-event-infomation">
          ...
          <div class="wpem-event-details">
            ...
            <p style="padding: 0 20px;margin-bottom: 20px;color: #060c22;font-style: italic;font-size: 15px; white-space: nowrap;  overflow: hidden;  text-overflow: ellipsis;text-align: center;"><i><?php display_event_start_date();?> <?php //display_date_time_separator() ?> <?php display_event_start_time();?> <?php 
              if (isset($start_date) && isset($end_date) && $start_date != $end_date ){
                display_event_end_date();
               // display_date_time_separator();
              } 
            ?> <?php display_event_end_time();?></i></p>
            ...
            <?php } ?>
              <?php /*HERE*/ $exerpt = apply_filters( 'display_event_description', get_the_excerpt() ); ?>
              <?=$exerpt;?>
            <!-- Show in list View // Hide in Box View -->
            <div class="text-center"><a href="<?php display_event_permalink(); ?>"> <button class="btn-style">Read More </button></a></div>
          </div>
      </div>   
